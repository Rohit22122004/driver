...
interface AnimatedGradientBackgroundProps {
    ...
    fixed?: boolean; // if true, canvas is fixed to viewport
    baseFill?: string | null; // if set, fill the base each frame to avoid white bleed-through
}
...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function animate() {
            ...
            // Optionally paint a solid base so backdrop-blur cards never reveal white
            ctx.resetTransform?.();
